...
export default function SummerNotification() {
  ...
  useEffect(() => {
    ...
    // Zobraziť posledných 14 dní pred 1. septembrom (18.–31. august)
    const isLastTwoWeeks = (month === 7 && day >= 18);
  ...
  return (
    <div
      className="fixed bottom-24 sm:bottom-5 right-5 left-4 sm:left-auto z-[9999] sm:w-[calc(100%-2rem)] max-w-sm animate-slide-up"
      role="alert"
      aria-live="polite"
    >
      <div
